...
void SG_psrd_float( float2 pos, float2 per, float rot, out float3 o )
{
    o = psrdnoise(pos, per, rot);
}

void SG_psr_float( float2 pos, float2 per, float rot, out float o )
{
    o = psrnoise(pos, per, rot);
}

void SG_srd_float( float2 pos, float rot, out float3 o )
{
    o = srdnoise(pos, rot);
}

void SG_sr_float( float2 pos, float rot, out float o )
{
    o = srnoise(pos, rot);
}